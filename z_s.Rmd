...
# 3. Plot with ggplot2
inf_plot<-ggplot(data_plot, aes(y = ghsl, x = N_INDVI)) +
  geom_point() +
...
ghsl_surv_a<-ggplot(subset_data, aes(y = ghsl, x = N_INDVI, color = Sit_Stt)) +
  #geom_point(alpha=0.2) +
  geom_jitter(aes(x =as.numeric(N_INDVI) , y = as.numeric(ghsl)),size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
ghsl_surv_greater <- ggplot(subset(camps, as.numeric(N_INDVI) > 10000), aes(y = ghsl, x = N_INDVI, color = Sit_Stt)) +
  geom_jitter(aes(x = as.numeric(N_INDVI), y = as.numeric(ghsl)), size = 0.6, alpha = 0.4, show.legend = TRUE) +
  labs(title = "Comparison between estimated and survey iom populations",
       y = "Estimated GHSL population",
...
ggsave("Plots/ghsl_shlt_typ", plot =ghsl_shlt_typ, width = 8, height = 6, dpi = 400)
#10.Settlement class wise calc vs estimated plot
ggsave("Plots/ghsl_st_cl", plot=ghsl_st_cl,width = 8, height = 6, dpi = 400)
...
gsave("Plots/hh_ghsl_c.png", plot =hh_ghsl_c, width = 8, height = 6, dpi = 400)
```
...
# 3. Plot with ggplot2
inf_plot_wp_uc<-ggplot(data_plot, aes(y = wp_uc, x = N_INDVI)) +
  #geom_point() +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(wp_uc)), size = 0.6, alpha = 0.8,show.legend = TRUE)
...
```{r}
# Scatter plot with site_status
wp_uc_surv_a<-ggplot(subset_data, aes(y = wp_uc, x = N_INDVI, color = Sit_Stt)) +
  #geom_point(alpha=0.2) +
  geom_jitter(aes(x =as.numeric(N_INDVI) , y = as.numeric(wp_uc)),size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
# Scatter plot with site_status for N_INDVI less than or equal to 10,000
wp_uc_surv_lesser <- ggplot(subset(camps, as.numeric(N_INDVI) <= 10000), aes(y = wp_uc, x = N_INDVI, color = Sit_Stt)) +
  geom_jitter(aes(x = as.numeric(N_INDVI), y = as.numeric(wp_uc)), size = 0.6, alpha = 0.4, show.legend = TRUE) +
  labs(title = "Comparison between estimated and survey iom populations",
...
gsave("Plots/WP_uc_N_HH.png", plot =WP_uc_N_HH, width = 8, height = 6, dpi = 400)
```
...
# 3. Plot with ggplot2
inf_plot_wp_c<-ggplot(data_plot, aes(y = wp_c, x = N_INDVI)) +
  #geom_point() +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(wp_c)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
# 3. Plot with ggplot2
info_fil_wp_c<-ggplot(data_plot, aes(x = N_INDVI, y = wp_c)) +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(wp_c)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
  #geom_point() +
...
```{r}
# Scatter plot with site_status
wp_c_surv_a<-ggplot(subset_data, aes(y = wp_c, x = N_INDVI, color = Sit_Stt)) +
  #geom_point(alpha=0.2) +
  geom_jitter(aes(x =as.numeric(N_INDVI) , y = as.numeric(wp_c)),size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
# Scatter plot with site_status for N_INDVI less than or equal to 10,000
wp_c_surv_lesser <- ggplot(subset(camps, as.numeric(N_INDVI) <= 10000), aes(y = wp_c, x = N_INDVI, color = Sit_Stt)) +
  geom_jitter(aes(x = as.numeric(N_INDVI), y = as.numeric(wp_c)), size = 0.6, alpha = 0.4, show.legend = TRUE) +
  labs(title = "Comparison between estimated and survey iom populations",
...
# 3. Plot with ggplot2
inf_plot_gpw<-ggplot(data_plot, aes(y = gpw, x = N_INDVI)) +
  #geom_point() +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(gpw)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
# 3. Plot with ggplot2
for_plot_gpw<-ggplot(data_plot, aes(y = gpw, x = N_INDVI)) +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(gpw)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
  #geom_point() +
...
# 3. Plot with ggplot2
info_fil_gpw<-ggplot(data_plot, aes(x = N_INDVI, y = gpw)) +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(gpw)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
  #geom_point() +
...
```{r}
# Scatter plot with site_status
gpw_surv_a<-ggplot(subset_data, aes(y = gpw, x = N_INDVI, color = Sit_Stt)) +
  #geom_point(alpha=0.2) +
  geom_jitter(aes(x =as.numeric(N_INDVI) , y = as.numeric(gpw)),size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
# Scatter plot with site_status for N_INDVI greater than 10,000
gpw_surv_greater <- ggplot(subset(camps, as.numeric(N_INDVI) > 10000), aes(y = gpw, x = N_INDVI, color = Sit_Stt)) +
...
# 3. Plot with ggplot2
inf_plot_gpw_UN<-ggplot(data_plot_gpw_U, aes(y = gpw_UN, x = N_INDVI)) +
  #geom_point() +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(gpw_UN)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
...
# 3. Plot with ggplot2
for_plot_gpw_UN<-ggplot(data_plot_gpw_U, aes(y = gpw_UN, x = N_INDVI)) +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(gpw_UN)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
  #geom_point() +
...
# 3. Plot with ggplot2
info_fil_gpw_UN<-ggplot(data_plot_gpw_U, aes(x = N_INDVI, y = gpw_UN)) +
  geom_jitter(aes(x = (as.numeric(N_INDVI)),y = as.numeric(gpw_UN)), size = 0.6, alpha = 0.8,show.legend = TRUE)+
  #geom_point() +
...
# Scatter plot with site_status for N_INDVI greater than 10,000
gpw_UN_surv_greater <- ggplot(subset(camps, as.numeric(N_INDVI) > 10000), aes(y = gpw_UN, x = N_INDVI, color = Sit_Stt)) +
...
numeric_cols <- c("N_INDVI", "ghsl", "wp_c", "wp_uc", "gpw","gpw_UN")
...
rownames(corr_matrix) <- colnames(corr_matrix) <- c("N_INDVI", "ghsl", "wp_con", "wp_uncon", "gpw","gpw_UN")
...
# [1]  0.8214727
```
#3.Informal sites only ms_building count vs population
```{r}
# 1. Subset the informal camps
informal_camps <- camps %>% filter(Sit_Stt == "Informal")
...
#4. Informal sites only ms_building count vs number of households
...
#5. Formal sites only ms_building count vs survey population

#6. Formal sites only ms_building count vs number of households
...
#3.Informal sites only google_building count vs population
```{r}

```


#4. Informal sites only google_building count vs number of households
```{r}
# Scatter plot with site_status
g_b_hh_inf<-ggplot(subset_data, aes(y = g_b_c, x = N_HH, color = Sit_Stt)) +
  #geom_point(alpha=0.2) +
  geom_jitter(aes(x =as.numeric(N_HH) , y = as.numeric(g_b_c)),shape=7,size = 0.5, alpha = 2,show.legend = TRUE)+
  
  labs(title = "Comparison between Google building count and survey Household count for the informal Site status",
       y = "Google building count",
       x = "Iom surveyed household count(Informal)") +
  theme_minimal()+scale_x_continuous(expand = c(0,0))  # Adjust axis scale to start from zero
  print(g_b_hh_inf)
```

#5. Formal sites only google_building count vs survey population

#6. Formal sites only google_building count vs number of households
...
```
#3.Informal sites only vida_building count vs population


#4. Informal sites only vida_building count vs number of households

#5. Formal sites only vida_building count vs survey population

#6. Formal sites only vida_building count vs number of households
...
#3.Informal sites only osm_building count vs population


#4. Informal sites only osm_building count vs number of households

#5. Formal sites only osm_building count vs survey population

#6. Formal sites only osm_building count vs number of households
