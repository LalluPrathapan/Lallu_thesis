...
```{r}
# Create boxplot for N_INDVI, ghsl, wp_uc, wp_c, and gpw on the same graph
combined_boxplot <- ggplot(camps) +
   geom_boxplot(aes(x = "Sit_Stt", y = N_INDVI, fill = "N_INDVI"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "Sit_Stt", y = ghsl, fill = "ghsl"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "Sit_Stt", y = wp_uc, fill = "wp_uc"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "Sit_Stt", y = wp_c, fill = "wp_c"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "Sit_Stt", y = gpw, fill = "gpw"), alpha = 0.2, width = 0.5) +
  geom_jitter(aes(x = "Sit_Stt", y = N_INDVI), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "Sit_Stt", y = ghsl), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "Sit_Stt", y = wp_uc), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "Sit_Stt", y = wp_c), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "Sit_Stt", y = gpw), color = "grey", size = 0.2, alpha = 0.5) +
  labs(title = "P opulation from IOM survey(N_INDVI), ghsl, wp_uc, wp_c, and gpw", x = "Sit_Stt", y = "Value") +
   theme_minimal() +
...
```{r}
# Create a new column indicating the variable name
build_stats_inc$variable1 <- "ghsl"
```

```{r}
# Create violin plot for ghsl
ghsl_violin_plot <- ggplot(camps, aes(x = "N_INDIV", y =ghsl, fill = "N_INDIV")) +
  geom_violin(trim = FALSE, alpha = 0.8) +
  geom_boxplot(width = 0.1, fill = "white", color = "black") +
  geom_jitter(position = position_jitter(width = 0.2), color = "grey", size = 0.5, alpha = 0.5) +
  labs(title = "Violin Plot of survey data", x = "N_INDIV", y = "Value") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5),
        legend.position = "bottom") +
  scale_fill_manual(values = c("N_INDIV" = "red"))

# Display the ghsl violin plot
print(ghsl_violin_plot)
```


```{r}
# Combine boxplots and violin plots into a single graph
combined_plot <- ggplot(camps) +
  # Boxplots
  geom_boxplot(aes(x = "N_INDVI", y = N_INDVI, fill = "N_INDVI"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "ghsl", y = ghsl, fill = "ghsl"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "wp_uc", y = wp_uc, fill = "wp_uc"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "wp_c", y = wp_c, fill = "wp_c"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "gpw", y = gpw, fill = "gpw"), alpha = 0.2, width = 0.5) +
  # Violin plots
  geom_violin(aes(x = "N_INDVI", y = N_INDVI, fill = "N_INDVI"), alpha = 0.8) +
  geom_violin(aes(x = "ghsl", y = ghsl, fill = "ghsl"), alpha = 0.8) +
  geom_violin(aes(x = "wp_uc", y = wp_uc, fill = "wp_uc"), alpha = 0.8) +
  geom_violin(aes(x = "wp_c", y = wp_c, fill = "wp_c"), alpha = 0.8) +
  geom_violin(aes(x = "gpw", y = gpw, fill = "gpw"), alpha = 0.8) +
  # Jitter points
  geom_jitter(aes(x = "N_INDVI", y = N_INDVI), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "ghsl", y = ghsl), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "wp_uc", y = wp_uc), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "wp_c", y = wp_c), color = "grey", size = 0.2, alpha = 0.5) +
  geom_jitter(aes(x = "gpw", y = gpw), color = "grey", size = 0.2, alpha = 0.5) +
  # Facet by variable
  #facet_wrap(~ variable, scales = "free", ncol = 2) +
  # Customize labels and themes
  labs(title = "Population from IOM survey (N_INDVI), ghsl, wp_uc, wp_c, and gpw", x = NULL, y = "Value") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
