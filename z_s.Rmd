...
combined_boxplot <- ggplot(build_stats_inc) +
  ...
  labs(title = "P opulation from IOM survey(N_INDVI), ghsl, wp_uc, wp_c, and gpw", x = NULL, y = "Value") +
  theme_minimal() +
...
ghsl_violin_plot <- ggplot(build_stats_inc, aes(x = "N_INDIV", y =ghsl, fill = "N_INDIV")) +
...
combined_plot <- ggplot(build_stats_inc) +
  # Boxplots
  geom_boxplot(aes(x = "N_INDVI", y = N_INDVI, fill = "N_INDVI"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "ghsl", y = ghsl, fill = "ghsl"), alpha = 0.2, width = 0.5) +
  geom_boxplot(aes(x = "wp_uc", y = wp_uc, fill = "wp_uc"), alpha = 0.2, width = 0.5) +
