...
ghsl_surv<-ggplot(camps, aes(y = ghsl, x = N_INDVI, color = Sit_Stt)) +
  ...
  geom_jitter(aes(y =as.numeric(N_INDVI) , x = as.numeric(ghsl)),shape=3,size = 0.5, alpha = 2,show.legend = TRUE)+
...
str(camps[, c("N_INDVI", "ghsl", "wp_con", "wp_uncon", "gpw")])

# Check for missing values
summary(camps[, c("N_INDVI", "ghsl", "wp_con", "wp_uncon", "gpw")])
...
cor_matrix <- matrix(c(corr_ghsl, corr_wp_con, corr_wp_uncon, corr_gpw),
                     nrow = 1, byrow = TRUE,
                     dimnames = list(c("N_INDVI"), c("ghsl", "wp_con", "wp_uncon", "gpw")))

# Plot the correlation matrix
cor_coe<-corrplot(cor_matrix, method = "color", type = "upper", 
...
numeric_cols <- c("N_INDVI", "ghsl", "wp_con", "wp_uncon", "gpw")
...
rownames(corr_matrix) <- colnames(corr_matrix) <- c("N_INDVI", "ghsl", "wp_con", "wp_uncon", "gpw")
