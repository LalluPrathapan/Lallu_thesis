...
build_stats_inc$cal_Shape_Area <-st_area(build_stats_inc$geometry)

# Print or view the results
print(build_stats_inc[, c("Name", "cal_Shape_Area","Site_Ar")])

# Remove 'units' from the columns
build_stats_inc$cal_Shape_Area <- as.numeric(build_stats_inc$cal_Shape_Area)
...
build_stats_inc$Area_Diff <- build_stats_inc$Site_Ar-build_stats_inc$cal_Shape_Area

print(build_stats_inc[, c("Name", "cal_Shape_Area","Site_Ar","Area_Diff")])
```
...
```{r}
grd3_path<-"D:/EAGLE/Master_Thesis_Hannes/1/grd3_settlementextent/nga_stlext_grid3_v02_-3462370684766222297/nga_stlext_grid3_v02.shp"
...
```{r}
#attributes_to_remove <- c("Shape_Area");

# Remove specified attributes
#build_stats_inc <- build_stats_inc %>%
