...
str(camps)
```
#converting as.numeric for many columns
...
camp_final$wp_uc_df <- as.numeric(camp_final$N_INDVI) - as.numeric(camp_final$wp_uc)
...
# Subtract N_INDVID from ras_name
camp_final$wp_c_df <- camps$N_INDVI - camp_final$wp_c
...
output_file <- paste0(output_directory, "camp_final_data.shp")

# Save the shapefile
st_write(camp_final_sf, output_file, delete_dsn = TRUE) 
```
