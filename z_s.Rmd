...
#3. Dou_level 1 and google building count
```{r}
# Convert factors to character to avoid issues in ggplot2
camp_final$dou_level1 <- as.character(camp_final$dou_level1)
...
p + geom_text(aes(label = Building_Count), position = position_stack(vjust = 0.5), size = 2, color = "black")

```

```{r}
# Save the plot to a file
ggsave("Plots/dou_1_building_bar.png", plot =p, width = 8, height = 6, dpi = 400)
```
